...
export const respondApproval: BridgeClient['respondApproval'] = (id, d) => getClient().respondApproval(id, d)
export const respondQuestion: BridgeClient['respondQuestion'] = (s, a) => getClient().respondQuestion(s, a)
