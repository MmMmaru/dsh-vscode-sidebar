...
test('stripVscodeContext removes the [DSH_VSCODE_CONTEXT] block', () => {
  const input = `${VSCODE_CONTEXT_PROMPT}\n\nHello, can you help me?`
  const result = stripVscodeContext(input)
  assert.equal(result, 'Hello, can you help me?')
})
